...
from osrl.common.net import (VAE, EnsembleDoubleQCritic,
                             MLPGaussianPerturbationActor)


class SOSRL(nn.Module):
    """
        Semi-offline Safe RL (SOSRL)
    ...
    def actor_loss(self, observations):
        ...
        qc_penalty = ((qc_pi - self.qc_thres) * self.multiplier).mean()
